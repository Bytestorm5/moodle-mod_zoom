...
$string['dropboxintegrationsettings'] = 'Dropbox integration';
$string['dropboxintegrationsettings_desc'] = 'Configure Dropbox for migrating Zoom cloud recordings to Dropbox automatically.';
$string['dropboxtoken'] = 'Dropbox access token';
$string['dropboxtoken_desc'] = 'Provide a Dropbox OAuth 2 access token with permission to upload files and create shared links. This token will be used by the scheduled task which migrates Zoom recording links to Dropbox.';
$string['dropboxappkey'] = 'Dropbox App key';
$string['dropboxappkey_desc'] = 'Optional. App key from your Dropbox app (for short-lived tokens).';
$string['dropboxappsecret'] = 'Dropbox App secret';
$string['dropboxappsecret_desc'] = 'Optional. App secret from your Dropbox app (for short-lived tokens). Stored securely.';
$string['dropboxrefreshtoken'] = 'Dropbox refresh token';
$string['dropboxrefreshtoken_desc'] = 'Optional. A long-lived refresh token generated for your Dropbox app. The plugin will exchange it for short-lived access tokens automatically. If set, this takes precedence over the static access token.';
$string['dropboxauth_start'] = 'Connect Dropbox (obtain refresh token)';
$string['dropboxauth_success'] = 'Dropbox connected successfully. Refresh token stored.';
$string['dropboxauth_error_state'] = 'Invalid Dropbox authorization state.';
$string['dropboxauth_error_config'] = 'Dropbox app key/secret not configured.';
$string['dropboxauth_error_http'] = 'Dropbox OAuth error: {$a}';
$string['dropboxauth_error_missing_refresh'] = 'Dropbox did not return a refresh token. Ensure token_access_type=offline is enabled for your app.';
$string['dropboxauth_log'] = 'Diagnostic log';
...
$string['migraterecordingstodropbox'] = 'Migrate recording links to Dropbox';
